# --------------------------------------------------------
# SiamMask class
# Intake from https://github.com/foolwood/SiamMask/blob/master/models/siammask_sharp.py
# TODO: Clean up irrelevant functions after we finish training stage
# --------------------------------------------------------
...
class SiamMask(nn.Module):
    ...
    def feature_extractor(self, x, save_fm=False):
        feature_maps, feature = self.features(x)
        if save_fm:
